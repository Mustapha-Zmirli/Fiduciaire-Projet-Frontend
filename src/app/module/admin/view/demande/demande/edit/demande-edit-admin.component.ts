...
export class DemandeEditAdminComponent extends AbstractEditController<DemandeDto, DemandeCriteria, DemandeAdminService>   implements OnInit {
    ...
    public override prepareEdit() {
        this.item.dateDemande = this.demandeService.format(this.item.dateDemande);
        this.item.dateExigibilite = this.demandeService.format(this.item.dateExigibilite);
        this.item.dateValidation = this.demandeService.format(this.item.dateValidation);
        this.item.dateTraitement = this.demandeService.format(this.item.dateTraitement);
    }
